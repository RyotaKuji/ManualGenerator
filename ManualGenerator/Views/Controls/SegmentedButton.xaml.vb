Public Class SegmentedButton
	...
	Public Shared ReadOnly _Item1 As DependencyProperty =
		DependencyProperty.Register("Item1", GetType(Object), GetType(SegmentedButton), New PropertyMetadata(Nothing))
	...
	Public Shared ReadOnly _Item2 As DependencyProperty =
		DependencyProperty.Register("Item2", GetType(Object), GetType(SegmentedButton), New PropertyMetadata(Nothing))
